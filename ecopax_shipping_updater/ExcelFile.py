...
from shipping_container import *
import os
            ...
            while j < len(sheet_data.index):
                ...
                if isinstance(row[container_num_column - 1], str) and self.container_num_pattern.match(row[container_num_column - 1]):
                    ...
                    if obj_carrier_company in self.accepted_container_carriers:
                        new_shipping_cont = shipping_container(obj_container_num, obj_carrier_company, obj_arrival_date, self.file_path, self.sheet_names[i], obj_container_num_location, obj_arrival_date_location)
