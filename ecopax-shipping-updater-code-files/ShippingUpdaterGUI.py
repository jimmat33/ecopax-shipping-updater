...
class ShippingUpdaterGUI(object):
    def __init__(self):
        ...
        if os.path.exists(os.path.abspath
                      ('Ecopax-Shipping-Updater-Program-Files\\gui_icon.png')):
            pic_fp = os.path.abspath(
            'Ecopax-Shipping-Updater-Program-Files\\gui_icon.png')
        else:
            pic_fp = os.path.abspath('gui_icon.png')

        img = tk.PhotoImage(file=pic_fp)
...
#container table
    ...
    def run_search_btn_click(self):
        try:
            ...
            messagebox.showerror('Search Error', 'There was an completing the container search. Please try another file, or contact James Mattison')
