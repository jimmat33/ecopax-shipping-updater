...
class EvergreenSearch(object):
    ...
    def pull_date(self, driver, i):
        try:
            str_date = driver.find_element(By.XPATH, '/html/body/div[5]/center/table[3]/tbody/tr/td/table[2]/tbody/tr/td').get_attribute('textContent')
    ...
    def original_search(self, driver, i):
        try:
            ...
            driver.find_element(By.XPATH, '/html/body/div[4]/center/table[2]/tbody/tr/td/form/nav/div/button[1]').click()

            driver.find_element(By.XPATH, '/html/body/div[4]/center/table[2]/tbody/tr/td/form/div/div[2]/table/tbody/tr[1]/td/table/tbody/tr[1]/td[1]/table/tbody/tr/td[2]/div[2]/input').click()
            textbox = driver.find_element(By.XPATH, '/html/body/div[4]/center/table[2]/tbody/tr/td/form/div/div[2]/table/tbody/tr[1]/td/table/tbody/tr[1]/td[2]/table/tbody/tr/td/div[1]/input')                                        
            textbox.clear()
            textbox.send_keys(self.container_num_list[i][0])
            driver.find_element(By.XPATH, '/html/body/div[4]/center/table[2]/tbody/tr/td/form/div/div[2]/table/tbody/tr[1]/td/table/tbody/tr[1]/td[2]/table/tbody/tr/td/div[2]/input').click()
    ...
    def modify_search(self, driver, i):
        try:
            #accessign textbox, inputting number and clicking search
            textbox = driver.find_element(By.XPATH, '/html/body/div[5]/center/table[2]/tbody/tr/td/form/div/table/tbody/tr/td[2]/table/tbody/tr/td/div[1]/input')                                        
            textbox.clear()
            textbox.send_keys(self.container_num_list[i][0])
            driver.find_element(By.XPATH, '/html/body/div[5]/center/table[2]/tbody/tr/td/form/div/table/tbody/tr/td[2]/table/tbody/tr/td/div[2]/input').click()
...
def evergreen_search():
    ...
    if len(evergreen_search_list) != 0:
        ...
        if evergreen.db_changes == 0:
            ...
            db_add_error('Evergreen Search Failed')
